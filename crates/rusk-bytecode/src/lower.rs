...
fn core_intrinsic(name: &str) -> Option<Intrinsic> {
    Some(match name {
        ...
        "core::intrinsics::int_to_le" => Intrinsic::IntToLe,
        "core::intrinsics::int_to_be" => Intrinsic::IntToBe,
        "core::intrinsics::int_from_le" => Intrinsic::IntFromLe,
        "core::intrinsics::int_from_be" => Intrinsic::IntFromBe,
        ...
        "core::intrinsics::identity_eq" => Intrinsic::IdentityEq,
        "core::intrinsics::identity_ne" => Intrinsic::IdentityNe,

        "Option::is_some" => Intrinsic::OptionIsSome,
        "Option::is_none" => Intrinsic::OptionIsNone,
        "Option::unwrap" => Intrinsic::OptionUnwrap,
        "Option::expect" => Intrinsic::OptionExpect,

        "core::intrinsics::string_len" => Intrinsic::StringLen,
        "core::intrinsics::string_split" => Intrinsic::StringSplit,
        "core::intrinsics::string_join" => Intrinsic::StringJoin,
        "core::intrinsics::string_replace" => Intrinsic::StringReplace,
        "core::intrinsics::string_to_array" => Intrinsic::StringToArray,
        "core::intrinsics::bytes_new" => Intrinsic::BytesNew,
        ...
        "core::intrinsics::bytes_concat" => Intrinsic::BytesConcat,
        "core::intrinsics::bytes_get" => Intrinsic::BytesGet,
        "core::intrinsics::bytes_set" => Intrinsic::BytesSet,
        "core::intrinsics::bytes_push_back" => Intrinsic::BytesPushBack,
        "core::intrinsics::string_to_utf8_bytes" => Intrinsic::StringToUtf8Bytes,
        "core::intrinsics::bytes_to_string_utf8_strict" => Intrinsic::BytesToStringUtf8Strict,
        "core::intrinsics::bytes_to_string_utf8_lossy" => Intrinsic::BytesToStringUtf8Lossy,
        ...
        "core::intrinsics::array_pop_front" => Intrinsic::ArrayPopFront,
        "core::intrinsics::array_get" => Intrinsic::ArrayGet,
        "core::intrinsics::array_get_ro" => Intrinsic::ArrayGetRo,
